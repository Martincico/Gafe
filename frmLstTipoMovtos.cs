...
namespace GAFE
{
    public partial class frmLstTipoMovtos : MetroForm
    {
        ...
        public frmLstTipoMovtos()
        {
            InitializeComponent();
        }


        public frmLstTipoMovtos(MsSql Odat, DatCfgParamSystem ParamS, DatCfgUsuario DatUsr, clsStiloTemas NewColor)
        {
            InitializeComponent();
            db = Odat;
            user = DatUsr;
