...
namespace GAFE
{
    class PuiCatCfgDocumentos
    {
        ...
        private int EditaPrecio;
        private int MuestraPrecio;
        ...
        public int cmpMuestraPrecio
        {
            get { return MuestraPrecio; }
            set { MuestraPrecio = value; }
        }
        public int cmpEditaPrecio
        {
            get { return EditaPrecio; }
            set { EditaPrecio = value; }
        }
        ...
        public void EditarCfgDocumentos()
        {
            ...
            MuestraPrecio = int.Parse(ObjA[18].ToString());
            EditaPrecio = int.Parse(ObjA[19].ToString());
        ...
        private void CargaParametroMat()
        {
            ...
            MatParam[18, 0] = "MuestraPrecio"; MatParam[18, 1] = MuestraPrecio;
            MatParam[19, 0] = "EditaPrecio"; MatParam[19, 1] = EditaPrecio;
        }
