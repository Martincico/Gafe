...
namespace GAFE
{
    public partial class frmLstCfgTipoMovProv : MetroForm
    {
        ...
        private void cmdBuscar_Click(object sender, EventArgs e)
        {
            ...
            DatosTbl = pui.BuscaTipoMovProv(txtBuscar.Text);
        ...
        {
            PuiCatCfgTipoMovProv pui = new PuiCatCfgTipoMovProv(db);
            DatosTbl = pui.ListarTipoMovProvs();
            DataSet Ds = new DataSet();
            try
            {
                DatosTbl.Fill(Ds);
        ...
        private void frmCatCfgDocumentos_CaptionBarPaint(object sender, PaintEventArgs e)
        {
